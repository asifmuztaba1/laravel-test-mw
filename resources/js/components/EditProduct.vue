<template>
    <section>
        ...
        <button @click="addProductToDb" type="submit" class="btn btn-lg btn-primary">Save</button>
...
export default {
    ...
    methods: {
        ...
        saveProductData:async function (files, xhr, formData)  {
            ...
            formData.append("product_image",this.images);
        }
